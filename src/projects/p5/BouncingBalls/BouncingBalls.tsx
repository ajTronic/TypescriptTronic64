...
const BouncingBalls = () => {
  return (
    <>
        ...
        <script defer>{`
             ...
             btn.addEventListener("click", () => {
               Swal.fire({
                 ...
                 text: "This is a bouncing balls animation made in p5.js. Every ball has a velocity. When the ball hits the the ground, some of its velocity is removed and the sign of the velocity is reversed.",
                 icon: "info",
      ...
      <button className="btn swal2-confirm swal2-styled">Info</button>
      <canvas></canvas>
    </>
  );
};
